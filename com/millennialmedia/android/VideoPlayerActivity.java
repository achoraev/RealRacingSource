  ...
  implements MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener
{
  ...
  private boolean isActionable(Uri paramUri)
  {
    if (paramUri.getScheme().equalsIgnoreCase("mmsdk"))
    {
      ...
      MMLog.v("VideoPlayerActivity", String.format("Unrecognized mmsdk:// URI %s.", new Object[] { paramUri }));
    }
    return false;
  }
  ...
  void dispatchButtonClick(String paramString)
  {
    ...
    {
      return;
      MMLog.d("VideoPlayerActivity", String.format("Button Click with URL: %s", new Object[] { paramString }));
  ...
  protected void playVideo(int paramInt)
  {
    try
    {
      ...
      MMLog.d("VideoPlayerActivity", String.format("playVideo path: %s", new Object[] { str }));
    ...
    {
      MMLog.e("VideoPlayerActivity", "playVideo error: ", localException);
      errorPlayVideo("error: " + localException);
    }
  }
    ...
    extends HttpRedirection.RedirectionListenerImpl
  {
    ...
    public OverlaySettings getOverlaySettings()
    {
      ...
      if (localVideoPlayerActivity != null)
      {
        String str = localVideoPlayerActivity.lastOverlayOrientation;
        localOverlaySettings = null;
        if (str != null)
        {
          localOverlaySettings = new OverlaySettings();
          localOverlaySettings.orientation = localVideoPlayerActivity.lastOverlayOrientation;
        }
      }
