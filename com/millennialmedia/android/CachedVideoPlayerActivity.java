  ...
  implements Handler.Callback
{
  ...
  private void fadeButtons()
  {
    if ((this.videoAd != null) && (this.videoAd.buttons != null)) {
      for (int i = 0; i < this.videoAd.buttons.size(); i++)
      {
        ...
        MMLog.v("CachedVideoPlayerActivity", String.format("Button: %d alpha: %f", arrayOfObject));
      }
    }
  }
  ...
  private void initWebOverlay()
  {
    ...
    CachedVideoWebViewClientListener localCachedVideoWebViewClientListener = new CachedVideoWebViewClientListener(this);
    this.mWebView.setWebViewClient(new InterstitialWebViewClient(localCachedVideoWebViewClientListener, this.redirectListenerImpl));
  ...
  public boolean handleMessage(Message paramMessage)
  {
        ...
        if (canFadeButtons())
        {
          ...
          try
          {
            ...
            if (canFadeButtons())
            {
              ...
              MMLog.v("CachedVideoPlayerActivity", String.format("Beginning animation to visibility. Fade duration: %d Button: %d Time: %d", arrayOfObject));
            }
          }
          catch (IllegalStateException localIllegalStateException2)
          {
            for (;;)
            {
              MMLog.e("CachedVideoPlayerActivity", "Problem adding buttons", localIllegalStateException2);
            }
          }
        }
      }
    ...
    for (;;)
    {
      ...
      {
        MMLog.e("CachedVideoPlayerActivity", "Error with video check", localIllegalStateException1);
      }
      break;
      label486:
      hideHud();
  ...
  protected RelativeLayout initLayout()
  {
    ...
    do
    {
      ...
      {
        File localFile = AdCache.getInternalCacheDirectory(this.activity);
        int i = 0;
        ...
        if (i < localArrayList.size())
        {
          ...
          for (;;)
          {
            ...
            catch (Exception localException)
            {
              ...
              MMLog.e("CachedVideoPlayerActivity", "Problem creating layout with bitmap buttons: ", localException);
              continue;
              ...
              MMLog.v("CachedVideoPlayerActivity", String.format("Button: %d Anchor: %d Position: %d Anchor2: %d Position2: %d", arrayOfObject));
            ...
            localMessage2 = Message.obtain(this.logTimeAndEventhandler, 3, localVideoImage);
            this.logTimeAndEventhandler.sendMessageDelayed(localMessage2, localVideoImage.appearanceDelay);
            if (localVideoImage.inactivityTimeout > 0L)
            {
              localMessage1 = Message.obtain(this.logTimeAndEventhandler, 1, localVideoImage);
    ...
    extends MMWebViewClient.MMWebViewClientListener
  {
    ...
    {
      MMLog.d("CachedVideoPlayerActivity", "@@ ON PAGE FINISHED" + paramString);
    ...
    extends AsyncTask<Void, Void, String>
  {
    ...
    protected String doInBackground(Void... paramVarArgs)
    {
      ...
      catch (Exception localException)
      {
        for (;;)
        {
          MMLog.e("CachedVideoPlayerActivity", "Error with http web overlay", localException);
        }
      }
      return null;
    }
