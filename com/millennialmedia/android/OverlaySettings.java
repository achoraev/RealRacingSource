  ...
  implements Parcelable
{
  ...
  OverlaySettings(Parcel paramParcel)
  {
    ...
    {
      MMLog.e("OverlaySettings", "Exception Overlaysettings creationg from parcel: ", localException);
    }
  }
  ...
  public String toString()
  {
    ...
    arrayOfObject[8] = Boolean.valueOf(this.isTransparent);
    arrayOfObject[9] = Boolean.valueOf(this.useCustomClose);
    arrayOfObject[10] = this.orientation;
    return String.format("height %d width %d modal %b urlToLoad %s creatorAdImplId %s shouldResizeOverlay: %d transitionTime: %d overlayTransition: %s shouldMakeOverlayTransparent: %b shouldShowCustomClose: %b Orientation: %s", arrayOfObject);
  }
  ...
  public void writeToParcel(Parcel paramParcel, int paramInt)
  {
    ...
    arrayOfBoolean[2] = this.useCustomClose;
    arrayOfBoolean[3] = this.modal;
    arrayOfBoolean[4] = this.isFromInterstitial;
    arrayOfBoolean[5] = this.allowOrientationChange;
