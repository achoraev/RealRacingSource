  ...
  implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener
{
  ...
  private RealTimeSocket bA(String paramString)
  {
    ...
    catch (IOException localIOException)
    {
      for (;;)
      {
        GamesLog.q("GamesClientImpl", "connect() call failed on socket: " + localIOException.getMessage());
      }
    }
  }
  ...
  public Intent a(int paramInt1, byte[] paramArrayOfByte, int paramInt2, Bitmap paramBitmap, String paramString)
  {
    try
    {
      Intent localIntent = ((IGamesService)gS()).a(paramInt1, paramArrayOfByte, paramInt2, paramString);
  ...
  public Intent a(Room paramRoom, int paramInt)
  {
    try
    {
      Intent localIntent = ((IGamesService)gS()).a((RoomEntity)paramRoom.freeze(), paramInt);
      return localIntent;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public Intent a(String paramString, boolean paramBoolean1, boolean paramBoolean2, int paramInt)
  {
    try
    {
      Intent localIntent = ((IGamesService)gS()).a(paramString, paramBoolean1, paramBoolean2, paramInt);
      return localIntent;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public void a(BaseImplementation.b<Snapshots.CommitSnapshotResult> paramb, Snapshot paramSnapshot, SnapshotMetadataChange paramSnapshotMetadataChange)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      com.google.android.gms.common.data.a locala = paramSnapshotMetadataChange.lM();
      if (locala != null) {
        locala.a(getContext().getCacheDir());
      }
      Contents localContents = localSnapshotContents.getContents();
      localSnapshotContents.close();
      try
      {
        ((IGamesService)gS()).a(new SnapshotCommittedBinderCallbacks(paramb), paramSnapshot.getMetadata().getSnapshotId(), paramSnapshotMetadataChange, localContents);
        return;
      }
      catch (RemoteException localRemoteException)
      {
  ...
  public void a(BaseImplementation.b<Achievements.UpdateAchievementResult> paramb, String paramString, int paramInt)
  {
    ...
    for (Object localObject = null;; localObject = new AchievementUpdatedBinderCallback(paramb)) {
      try
      {
        ((IGamesService)gS()).a((IGamesCallbacks)localObject, paramString, paramInt, this.Wx.kO(), this.Wx.kN());
        return;
      }
      catch (RemoteException localRemoteException)
      {
  ...
  public void a(BaseImplementation.b<Leaderboards.SubmitScoreResult> paramb, String paramString1, long paramLong, String paramString2)
  {
    ...
    for (Object localObject = null;; localObject = new SubmitScoreBinderCallbacks(paramb)) {
      try
      {
        ((IGamesService)gS()).a((IGamesCallbacks)localObject, paramString1, paramLong, paramString2);
        return;
      }
      catch (RemoteException localRemoteException)
      {
  ...
  public void a(BaseImplementation.b<Snapshots.OpenSnapshotResult> paramb, String paramString1, String paramString2, SnapshotMetadataChange paramSnapshotMetadataChange, SnapshotContents paramSnapshotContents)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      Contents localContents = paramSnapshotContents.getContents();
      paramSnapshotContents.close();
      try
      {
        ((IGamesService)gS()).a(new SnapshotOpenedBinderCallbacks(paramb), paramString1, paramString2, paramSnapshotMetadataChange, localContents);
        return;
      }
      catch (RemoteException localRemoteException)
      {
  ...
  public Intent b(int[] paramArrayOfInt)
  {
    try
    {
      Intent localIntent = ((IGamesService)gS()).b(paramArrayOfInt);
      return localIntent;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public void b(BaseImplementation.b<Achievements.UpdateAchievementResult> paramb, String paramString)
  {
    ...
    for (Object localObject = null;; localObject = localAchievementUpdatedBinderCallback)
    {
      try
      {
        ((IGamesService)gS()).a((IGamesCallbacks)localObject, paramString, this.Wx.kO(), this.Wx.kN());
        return;
      }
      catch (RemoteException localRemoteException)
      {
  ...
  public void b(BaseImplementation.b<Achievements.UpdateAchievementResult> paramb, String paramString, int paramInt)
  {
    ...
    for (Object localObject = null;; localObject = new AchievementUpdatedBinderCallback(paramb)) {
      try
      {
        ((IGamesService)gS()).b((IGamesCallbacks)localObject, paramString, paramInt, this.Wx.kO(), this.Wx.kN());
        return;
      }
      catch (RemoteException localRemoteException)
      {
  ...
  public Intent bC(String paramString)
  {
    try
    {
      Intent localIntent = ((IGamesService)gS()).bC(paramString);
      return localIntent;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public Intent bx(String paramString)
  {
    try
    {
      Intent localIntent = ((IGamesService)gS()).bx(paramString);
      return localIntent;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public void c(BaseImplementation.b<Achievements.UpdateAchievementResult> paramb, String paramString)
  {
    ...
    for (Object localObject = null;; localObject = localAchievementUpdatedBinderCallback)
    {
      try
      {
        ((IGamesService)gS()).b((IGamesCallbacks)localObject, paramString, this.Wx.kO(), this.Wx.kN());
        return;
      }
      catch (RemoteException localRemoteException)
      {
  ...
  protected void c(String... paramVarArgs)
  {
    ...
    if (j != 0)
    {
      ...
      {
        o.a(bool2, "Cannot have both %s and %s!", new Object[] { "https://www.googleapis.com/auth/games", "https://www.googleapis.com/auth/games.firstparty" });
        return;
      }
    }
  ...
  public Player kc()
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 1068	com/google/android/gms/games/internal/GamesClientImpl:dJ	()V
    //   4: aload_0
    //   5: monitorenter
    //   6: aload_0
    //   7: getfield 221	com/google/android/gms/games/internal/GamesClientImpl:Wv	Lcom/google/android/gms/games/PlayerEntity;
    //   10: astore_2
    //   11: aload_2
    //   12: ifnonnull +51 -> 63
    //   15: new 1070	com/google/android/gms/games/PlayerBuffer
    //   18: dup
    //   19: aload_0
    //   20: invokevirtual 135	com/google/android/gms/games/internal/GamesClientImpl:gS	()Landroid/os/IInterface;
    //   23: checkcast 137	com/google/android/gms/games/internal/IGamesService
    //   26: invokeinterface 1074 1 0
    //   31: invokespecial 1075	com/google/android/gms/games/PlayerBuffer:<init>	(Lcom/google/android/gms/common/data/DataHolder;)V
    //   34: astore_3
    //   35: aload_3
    //   36: invokevirtual 1076	com/google/android/gms/games/PlayerBuffer:getCount	()I
    //   39: ifle +20 -> 59
    //   42: aload_0
    //   43: aload_3
    //   44: iconst_0
    //   45: invokevirtual 1079	com/google/android/gms/games/PlayerBuffer:get	(I)Lcom/google/android/gms/games/Player;
    //   48: invokeinterface 1082 1 0
    //   53: checkcast 1084	com/google/android/gms/games/PlayerEntity
    //   56: putfield 221	com/google/android/gms/games/internal/GamesClientImpl:Wv	Lcom/google/android/gms/games/PlayerEntity;
    //   59: aload_3
    //   60: invokevirtual 1085	com/google/android/gms/games/PlayerBuffer:release	()V
    //   63: aload_0
    //   64: monitorexit
    //   65: aload_0
    //   66: getfield 221	com/google/android/gms/games/internal/GamesClientImpl:Wv	Lcom/google/android/gms/games/PlayerEntity;
    //   69: areturn
    //   70: astore 4
    //   72: aload_3
    //   73: invokevirtual 1085	com/google/android/gms/games/PlayerBuffer:release	()V
    //   76: aload 4
    //   78: athrow
    //   79: astore 5
    //   81: ldc 160
    //   83: ldc_w 265
    //   86: invokestatic 268	com/google/android/gms/games/internal/GamesLog:p	(Ljava/lang/String;Ljava/lang/String;)V
    //   89: goto -26 -> 63
    //   92: astore_1
    //   93: aload_0
    //   94: monitorexit
  ...
  public com.google.android.gms.games.Game kd()
  {
    ...
    //   5: monitorenter
    //   6: aload_0
    //   7: getfield 1089	com/google/android/gms/games/internal/GamesClientImpl:Ww	Lcom/google/android/gms/games/GameEntity;
    //   10: astore_2
    //   11: aload_2
    //   12: ifnonnull +51 -> 63
    //   15: new 1091	com/google/android/gms/games/GameBuffer
    //   18: dup
    //   19: aload_0
    //   20: invokevirtual 135	com/google/android/gms/games/internal/GamesClientImpl:gS	()Landroid/os/IInterface;
    //   23: checkcast 137	com/google/android/gms/games/internal/IGamesService
    //   26: invokeinterface 1094 1 0
    //   31: invokespecial 1095	com/google/android/gms/games/GameBuffer:<init>	(Lcom/google/android/gms/common/data/DataHolder;)V
    //   34: astore_3
    //   35: aload_3
    //   36: invokevirtual 1096	com/google/android/gms/games/GameBuffer:getCount	()I
    //   39: ifle +20 -> 59
    //   42: aload_0
    //   43: aload_3
    //   44: iconst_0
    //   45: invokevirtual 1099	com/google/android/gms/games/GameBuffer:get	(I)Lcom/google/android/gms/games/Game;
    //   48: invokeinterface 1102 1 0
    //   53: checkcast 1104	com/google/android/gms/games/GameEntity
    //   56: putfield 1089	com/google/android/gms/games/internal/GamesClientImpl:Ww	Lcom/google/android/gms/games/GameEntity;
    //   59: aload_3
    //   60: invokevirtual 1105	com/google/android/gms/games/GameBuffer:release	()V
    //   63: aload_0
    //   64: monitorexit
    //   65: aload_0
    //   66: getfield 1089	com/google/android/gms/games/internal/GamesClientImpl:Ww	Lcom/google/android/gms/games/GameEntity;
    //   69: areturn
    //   70: astore 4
    //   72: aload_3
    //   73: invokevirtual 1105	com/google/android/gms/games/GameBuffer:release	()V
    //   76: aload 4
    //   78: athrow
    //   79: astore 5
    //   81: ldc 160
  ...
  public RealTimeSocket t(String paramString1, String paramString2)
  {
    ...
    if ((localRealTimeSocket == null) || (localRealTimeSocket.isClosed())) {
      localRealTimeSocket = bz(paramString2);
    }
    return localRealTimeSocket;
  }
    ...
    implements Quests.AcceptQuestResult
  {
    ...
    AcceptQuestResultImpl(DataHolder paramDataHolder)
    {
      ...
      //   0: aload_0
      //   1: aload_1
      //   2: invokespecial 12	com/google/android/gms/common/api/a:<init>	(Lcom/google/android/gms/common/data/DataHolder;)V
      ...
      //   37: putfield 32	com/google/android/gms/games/internal/GamesClientImpl$AcceptQuestResultImpl:WE	Lcom/google/android/gms/games/quest/Quest;
      //   40: aload_2
      //   41: invokevirtual 36	com/google/android/gms/games/quest/QuestBuffer:release	()V
      //   44: return
      //   45: aload_0
      //   46: aconst_null
      //   47: putfield 32	com/google/android/gms/games/internal/GamesClientImpl$AcceptQuestResultImpl:WE	Lcom/google/android/gms/games/quest/Quest;
      //   50: goto -10 -> 40
      //   53: astore_3
      //   54: aload_2
    ...
    implements Quests.ClaimMilestoneResult
  {
    ...
    ClaimMilestoneResultImpl(DataHolder paramDataHolder, String paramString)
    {
      ...
      //   2: aload_0
      //   3: aload_1
      //   4: invokespecial 15	com/google/android/gms/common/api/a:<init>	(Lcom/google/android/gms/common/data/DataHolder;)V
      ...
      //   42: putfield 35	com/google/android/gms/games/internal/GamesClientImpl$ClaimMilestoneResultImpl:WE	Lcom/google/android/gms/games/quest/Quest;
      //   45: aload_0
      //   46: getfield 35	com/google/android/gms/games/internal/GamesClientImpl$ClaimMilestoneResultImpl:WE	Lcom/google/android/gms/games/quest/Quest;
      ...
      //   106: putfield 59	com/google/android/gms/games/internal/GamesClientImpl$ClaimMilestoneResultImpl:WG	Lcom/google/android/gms/games/quest/Milestone;
      //   109: aload 4
      ...
      //   121: aload_0
      //   122: aconst_null
      //   123: putfield 59	com/google/android/gms/games/internal/GamesClientImpl$ClaimMilestoneResultImpl:WG	Lcom/google/android/gms/games/quest/Milestone;
      //   126: aload 4
      //   128: invokevirtual 63	com/google/android/gms/games/quest/QuestBuffer:release	()V
      //   131: return
      //   132: aload_0
      //   133: aconst_null
      //   134: putfield 59	com/google/android/gms/games/internal/GamesClientImpl$ClaimMilestoneResultImpl:WG	Lcom/google/android/gms/games/quest/Milestone;
      //   137: aload_0
      //   138: aconst_null
      //   139: putfield 35	com/google/android/gms/games/internal/GamesClientImpl$ClaimMilestoneResultImpl:WE	Lcom/google/android/gms/games/quest/Quest;
      //   142: goto -16 -> 126
      //   145: astore 5
      //   147: aload 4
    ...
    implements Snapshots.CommitSnapshotResult
  {
    ...
    CommitSnapshotResultImpl(DataHolder paramDataHolder)
    {
      ...
      //   34: putfield 30	com/google/android/gms/games/internal/GamesClientImpl$CommitSnapshotResultImpl:WH	Lcom/google/android/gms/games/snapshot/SnapshotMetadata;
      //   37: aload_2
      //   38: invokevirtual 34	com/google/android/gms/games/snapshot/SnapshotMetadataBuffer:release	()V
      //   41: return
      //   42: aload_0
      //   43: aconst_null
      //   44: putfield 30	com/google/android/gms/games/internal/GamesClientImpl$CommitSnapshotResultImpl:WH	Lcom/google/android/gms/games/snapshot/SnapshotMetadata;
      //   47: goto -10 -> 37
      //   50: astore_3
      //   51: aload_2
    ...
    implements Notifications.GameMuteStatusLoadResult
  {
    ...
    public GameMuteStatusLoadResultImpl(DataHolder paramDataHolder)
    {
      ...
      //   16: putfield 30	com/google/android/gms/games/internal/GamesClientImpl$GameMuteStatusLoadResultImpl:CM	Lcom/google/android/gms/common/api/Status;
      //   19: aload_1
      ...
      //   35: putfield 41	com/google/android/gms/games/internal/GamesClientImpl$GameMuteStatusLoadResultImpl:WJ	Ljava/lang/String;
      //   38: aload_0
      //   39: aload_1
      //   40: ldc 43
      //   42: iconst_0
      ...
      //   47: putfield 49	com/google/android/gms/games/internal/GamesClientImpl$GameMuteStatusLoadResultImpl:WK	Z
      //   50: aload_1
      //   51: invokevirtual 52	com/google/android/gms/common/data/DataHolder:close	()V
      //   54: return
      //   55: aload_0
      //   56: aconst_null
      //   57: putfield 41	com/google/android/gms/games/internal/GamesClientImpl$GameMuteStatusLoadResultImpl:WJ	Ljava/lang/String;
      //   60: aload_0
      //   61: iconst_0
      //   62: putfield 49	com/google/android/gms/games/internal/GamesClientImpl$GameMuteStatusLoadResultImpl:WK	Z
      //   65: goto -15 -> 50
      //   68: astore_2
      //   69: aload_1
    ...
    public void n(DataHolder paramDataHolder)
    {
      ...
      try
      {
        ...
        if (localInvitation != null) {
          GamesClientImpl.this.a(new GamesClientImpl.InvitationReceivedCallback(GamesClientImpl.this, this.WM, localInvitation));
        }
        return;
      }
      finally
    ...
    implements Leaderboards.LoadPlayerScoreResult
  {
    ...
    LoadPlayerScoreResultImpl(DataHolder paramDataHolder)
    {
      ...
      //   35: putfield 33	com/google/android/gms/games/internal/GamesClientImpl$LoadPlayerScoreResultImpl:WY	Lcom/google/android/gms/games/leaderboard/LeaderboardScoreEntity;
      //   38: aload_2
      //   39: invokevirtual 37	com/google/android/gms/games/leaderboard/LeaderboardScoreBuffer:release	()V
      //   42: return
      //   43: aload_0
      //   44: aconst_null
      //   45: putfield 33	com/google/android/gms/games/internal/GamesClientImpl$LoadPlayerScoreResultImpl:WY	Lcom/google/android/gms/games/leaderboard/LeaderboardScoreEntity;
      //   48: goto -10 -> 38
      //   51: astore_3
      //   52: aload_2
    ...
    implements Players.LoadProfileSettingsResult
  {
    ...
    LoadProfileSettingsResultImpl(DataHolder paramDataHolder)
    {
      ...
      //   12: aload_1
      //   13: iconst_0
      //   14: invokevirtual 23	com/google/android/gms/common/data/DataHolder:ar	(I)I
      //   17: istore_3
      //   18: aload_0
      //   19: aload_1
      //   20: ldc 25
      ...
      //   27: putfield 31	com/google/android/gms/games/internal/GamesClientImpl$LoadProfileSettingsResultImpl:Wp	Z
      //   30: aload_0
      //   31: aload_1
      //   32: ldc 33
      //   34: iconst_0
      ...
      //   39: putfield 35	com/google/android/gms/games/internal/GamesClientImpl$LoadProfileSettingsResultImpl:Xa	Z
      //   42: aload_1
      //   43: invokevirtual 39	com/google/android/gms/common/data/DataHolder:close	()V
      //   46: return
      //   47: aload_0
      //   48: iconst_1
      //   49: putfield 31	com/google/android/gms/games/internal/GamesClientImpl$LoadProfileSettingsResultImpl:Wp	Z
      //   52: aload_0
      //   53: iconst_0
      //   54: putfield 35	com/google/android/gms/games/internal/GamesClientImpl$LoadProfileSettingsResultImpl:Xa	Z
      //   57: goto -15 -> 42
      //   60: astore_2
      //   61: aload_1
    ...
    implements Requests.LoadRequestsResult
  {
    ...
    public void release()
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        DataHolder localDataHolder = (DataHolder)this.Xb.getParcelable(str);
    ...
    implements Leaderboards.LoadScoresResult
  {
    ...
    LoadScoresResultImpl(DataHolder paramDataHolder1, DataHolder paramDataHolder2)
    {
      ...
      //   38: putfield 36	com/google/android/gms/games/internal/GamesClientImpl$LoadScoresResultImpl:Xc	Lcom/google/android/gms/games/leaderboard/LeaderboardEntity;
      //   41: aload_3
      ...
      //   54: putfield 45	com/google/android/gms/games/internal/GamesClientImpl$LoadScoresResultImpl:Xd	Lcom/google/android/gms/games/leaderboard/LeaderboardScoreBuffer;
      //   57: return
      //   58: aload_0
      //   59: aconst_null
      //   60: putfield 36	com/google/android/gms/games/internal/GamesClientImpl$LoadScoresResultImpl:Xc	Lcom/google/android/gms/games/leaderboard/LeaderboardEntity;
      //   63: goto -22 -> 41
      //   66: astore 4
      //   68: aload_3
    ...
    public void t(DataHolder paramDataHolder)
    {
      ...
      try
      {
        ...
        if (localTurnBasedMatch != null) {
          GamesClientImpl.this.a(new GamesClientImpl.MatchUpdateReceivedCallback(GamesClientImpl.this, this.Xi, localTurnBasedMatch));
        }
        return;
      }
      finally
    ...
    extends AbstractGamesCallbacks
  {
    ...
    public void M(DataHolder paramDataHolder)
    {
      Quest localQuest = S(paramDataHolder);
      if (localQuest != null) {
        GamesClientImpl.this.a(new GamesClientImpl.QuestCompletedCallback(GamesClientImpl.this, this.Xv, localQuest));
      }
    }
  }
    ...
    public void o(DataHolder paramDataHolder)
    {
      ...
      try
      {
        ...
        if (localGameRequest != null) {
          GamesClientImpl.this.a(new GamesClientImpl.RequestReceivedCallback(GamesClientImpl.this, this.XA, localGameRequest));
        }
        return;
      }
      finally
    ...
    implements Requests.SendRequestResult
  {
    ...
    SendRequestResultImpl(DataHolder paramDataHolder)
    {
      ...
      //   38: putfield 31	com/google/android/gms/games/internal/GamesClientImpl$SendRequestResultImpl:XB	Lcom/google/android/gms/games/request/GameRequest;
      //   41: aload_2
      //   42: invokevirtual 35	com/google/android/gms/games/request/GameRequestBuffer:release	()V
      //   45: return
      //   46: aload_0
      //   47: aconst_null
      //   48: putfield 31	com/google/android/gms/games/internal/GamesClientImpl$SendRequestResultImpl:XB	Lcom/google/android/gms/games/request/GameRequest;
      //   51: goto -10 -> 41
      //   54: astore_3
      //   55: aload_2
    ...
    extends com.google.android.gms.common.api.a
  {
    ...
    TurnBasedMatchResult(DataHolder paramDataHolder)
    {
      ...
      //   0: aload_0
      //   1: aload_1
      //   2: invokespecial 10	com/google/android/gms/common/api/a:<init>	(Lcom/google/android/gms/common/data/DataHolder;)V
      ...
      //   38: putfield 29	com/google/android/gms/games/internal/GamesClientImpl$TurnBasedMatchResult:Xj	Lcom/google/android/gms/games/multiplayer/turnbased/TurnBasedMatch;
      //   41: aload_2
      //   42: invokevirtual 33	com/google/android/gms/games/multiplayer/turnbased/TurnBasedMatchBuffer:release	()V
      //   45: return
      //   46: aload_0
      //   47: aconst_null
      //   48: putfield 29	com/google/android/gms/games/internal/GamesClientImpl$TurnBasedMatchResult:Xj	Lcom/google/android/gms/games/multiplayer/turnbased/TurnBasedMatch;
      //   51: goto -10 -> 41
      //   54: astore_3
      //   55: aload_2
