    ...
    implements IRoomService
  {
      ...
      throws RemoteException
    {
      ...
      case 1006: 
        ...
        for (DataHolder localDataHolder = DataHolder.CREATOR.z(paramParcel1);; localDataHolder = null)
        {
      ...
      implements IRoomService
    {
        ...
        throws RemoteException
      {
        ...
        //   21: aload_0
        //   22: getfield 30	com/google/android/gms/games/internal/IRoomService$Stub$Proxy:lb	Landroid/os/IBinder;
        //   25: sipush 1008
        //   28: aload_3
        //   29: aconst_null
        //   30: iconst_1
