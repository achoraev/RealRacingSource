  ...
  static boolean a(Achievement paramAchievement, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (paramAchievement != paramObject)
      {
        ...
        {
          bool2 = n.equal(Integer.valueOf(localAchievement.getCurrentSteps()), Integer.valueOf(paramAchievement.getCurrentSteps()));
          bool1 = n.equal(Integer.valueOf(localAchievement.getTotalSteps()), Integer.valueOf(paramAchievement.getTotalSteps()));
        }
        while ((!n.equal(localAchievement.getAchievementId(), paramAchievement.getAchievementId())) || (!n.equal(localAchievement.getName(), paramAchievement.getName())) || (!n.equal(Integer.valueOf(localAchievement.getType()), Integer.valueOf(paramAchievement.getType()))) || (!n.equal(localAchievement.getDescription(), paramAchievement.getDescription())) || (!n.equal(Long.valueOf(localAchievement.getXpValue()), Long.valueOf(paramAchievement.getXpValue()))) || (!n.equal(Integer.valueOf(localAchievement.getState()), Integer.valueOf(paramAchievement.getState()))) || (!n.equal(Long.valueOf(localAchievement.getLastUpdatedTimestamp()), Long.valueOf(paramAchievement.getLastUpdatedTimestamp()))) || (!n.equal(localAchievement.getPlayer(), paramAchievement.getPlayer())) || (!bool2) || (!bool1))
        {
          return false;
          bool1 = i;
          bool2 = i;
