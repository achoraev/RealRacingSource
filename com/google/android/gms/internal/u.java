  ...
  implements aa, bw, bz, cb, cn, dn, dq, fa.a, fd.a, gd, t
{
  ...
  private fi.a a(av paramav, Bundle paramBundle)
  {
    ...
    if (!bool1)
    {
      localViewParent = this.lr.lz.getParent();
      localBundle1 = null;
      if (localViewParent != null)
      {
        ...
        i = arrayOfInt[0];
        j = arrayOfInt[1];
        localDisplayMetrics = this.lr.lB.getResources().getDisplayMetrics();
        k = this.lr.lz.getWidth();
        m = this.lr.lz.getHeight();
        bool2 = this.lr.lz.isShown();
        n = 0;
        if (bool2)
        {
          i1 = i + k;
    ...
    localBundle2 = gb.a(this.lr.lB, this, str);
    ...
    for (;;)
    {
      ...
      if (this.lr.lW == 0)
      {
        ...
        for (;;)
        {
          ...
          return;
          label648:
          if ((!(locala instanceof bo)) || (this.lr.lQ == null)) {
            break;
          }
          ao();
        }
