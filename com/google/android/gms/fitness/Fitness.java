...
public class Fitness
{
  ...
  private static final Api.b<kk, Api.ApiOptions.NoOptions> CV = new Api.b()
  {
    ...
    {
      String[] arrayOfString = a.d(paramAnonymousClientSettings.getScopes());
      return new kl(paramAnonymousContext, paramAnonymousLooper, paramAnonymousConnectionCallbacks, paramAnonymousOnConnectionFailedListener, paramAnonymousClientSettings.getAccountNameOrDefault(), arrayOfString);
    }
