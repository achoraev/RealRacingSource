  ...
  implements m
{
  ...
  private void a(aa paramaa, URL paramURL, boolean paramBoolean)
  {
    ...
    //   0	279	0	this	ag
    //   0	279	1	paramaa	aa
    //   0	279	2	paramURL	URL
    //   0	279	3	paramBoolean	boolean
    //   33	242	4	localURL	URL
    //   57	64	5	localHttpHost	HttpHost
    //   233	32	6	localIOException	IOException
    //   208	1	7	localClientProtocolException	ClientProtocolException
    //   72	51	8	localHttpEntityEnclosingRequest	HttpEntityEnclosingRequest
    //   129	58	9	localHttpResponse	HttpResponse
    //   143	29	10	i	int
    //   152	8	11	localHttpEntity	HttpEntity
    //   230	1	12	localMalformedURLException	MalformedURLException
    // Exception table:
    //   from	to	target	type
