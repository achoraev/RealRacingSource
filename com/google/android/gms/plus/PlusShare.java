  ...
  public static class Builder
  {
    ...
    public Intent getIntent()
    {
      ...
      if ((this.als != null) && (this.als.size() > i))
      {
        ...
        int n = i;
        label59:
        o.a(n, "Call-to-action buttons are only available for URLs.");
        if ((bool2) && (!this.mIntent.hasExtra("com.google.android.apps.plus.CONTENT_URL"))) {
          break label308;
        }
        int i2 = i;
        label86:
        o.a(i2, "The content URL is required for interactive posts.");
        ...
        label122:
        o.a(i, "Must set content URL or content deep-link ID to use a call-to-action button.");
