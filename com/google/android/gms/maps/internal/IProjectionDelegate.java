    ...
    implements IProjectionDelegate
  {
      ...
      implements IProjectionDelegate
    {
        ...
        throws RemoteException
      {
        ...
        //   32: aload_0
        //   33: getfield 15	com/google/android/gms/maps/internal/IProjectionDelegate$a$a:lb	Landroid/os/IBinder;
        //   36: iconst_1
        //   37: aload_2
        //   38: aload_3
        //   39: iconst_0
        ...
        //   67: aload_3
        //   68: invokevirtual 65	com/google/android/gms/maps/model/i:cM	(Landroid/os/Parcel;)Lcom/google/android/gms/maps/model/LatLng;
        //   71: astore 9
        //   73: aload 9
        //   75: astore 8
        //   77: aload_3
        ...
        throws RemoteException
      {
        ...
        //   11: invokevirtual 33	android/os/Parcel:writeInterfaceToken	(Ljava/lang/String;)V
        //   14: aload_0
        //   15: getfield 15	com/google/android/gms/maps/internal/IProjectionDelegate$a$a:lb	Landroid/os/IBinder;
        //   18: iconst_3
        //   19: aload_1
        //   20: aload_2
        //   21: iconst_0
        ...
        //   36: ifeq +27 -> 63
        //   39: getstatic 75	com/google/android/gms/maps/model/VisibleRegion:CREATOR	Lcom/google/android/gms/maps/model/y;
        //   42: aload_2
        //   43: invokevirtual 81	com/google/android/gms/maps/model/y:cW	(Landroid/os/Parcel;)Lcom/google/android/gms/maps/model/VisibleRegion;
        //   46: astore 6
        //   48: aload 6
        //   50: astore 5
        //   52: aload_2
        ...
        throws RemoteException
      {
        ...
        //   29: aload_0
        //   30: getfield 15	com/google/android/gms/maps/internal/IProjectionDelegate$a$a:lb	Landroid/os/IBinder;
        //   33: iconst_2
        //   34: aload_2
        //   35: aload_3
        //   36: iconst_0
        ...
        //   47: aload_3
        //   48: invokevirtual 94	android/os/Parcel:readStrongBinder	()Landroid/os/IBinder;
        //   51: invokestatic 100	com/google/android/gms/dynamic/d$a:am	(Landroid/os/IBinder;)Lcom/google/android/gms/dynamic/d;
        //   54: astore 6
        //   56: aload_3
        //   57: invokevirtual 68	android/os/Parcel:recycle	()V
        //   60: aload_2
