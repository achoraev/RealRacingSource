...
public class SynergyEnvironment
{
  ...
  public static final String SYNERGY_SERVER_FLAGS_CAN_SEND_MAC_ADDRESS = "sendMacAddress";
  public static final String SYNERGY_SERVER_FLAGS_CAN_SEND_UDID = "sendUDID";
  
  public static ISynergyEnvironment getComponent()
  {
    return (ISynergyEnvironment)Base.getComponent("com.ea.nimble.synergyEnvironment");
  }
}


/* Location:           E:\Dropbox\Dropbox\RealRacingHack\Decompile\install_dex2jar.jar
 * Qualified Name:     com.ea.nimble.SynergyEnvironment
