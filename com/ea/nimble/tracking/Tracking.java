...
public class Tracking
{
  ...
  {
    return (ITracking)Base.getComponent("com.ea.nimble.tracking");
  }
  
  private static void initialize()
  {
    Base.registerComponent(new TrackingWrangler(), "com.ea.nimble.tracking");
  }
  
  public static boolean isNimbleStandardEvent(String paramString)
  {
    if (paramString == null) {
      return false;
    }
    return paramString.startsWith("NIMBLESTANDARD::");
  }
  
  public static boolean isSessionEndEvent(String paramString)
  {
    if (paramString == null) {
      return false;
    }
    return paramString.startsWith("SESSION_END", "NIMBLESTANDARD::".length());
  }
  
  public static boolean isSessionStartEvent(String paramString)
  {
    if (paramString == null) {}
    while ((!paramString.startsWith("APPSTART_", "NIMBLESTANDARD::".length())) && (!paramString.equals("NIMBLESTANDARD::SESSION_START")) && (!paramString.startsWith("APPRESUME_", "NIMBLESTANDARD::".length()))) {
      return false;
    }
    return true;
  }
 ...
 * Qualified Name:     com.ea.nimble.tracking.Tracking
