...
public final class Controller
{
  ...
  public final int getInfo(int paramInt)
  {
    if (this.mService != null) {
      try
      {
        int i = this.mService.getInfo(paramInt);
        return i;
      }
      catch (RemoteException localRemoteException) {}
    }
  ...
  public final int getKeyCode(int paramInt)
  {
    ...
    try
    {
      int k = this.mService.getKeyCode2(1, paramInt);
      i = k;
      return i;
    }
    catch (RemoteException localRemoteException1)
    {
      ...
      for (;;)
      {
        try
        {
          int j = this.mService.getKeyCode(1, paramInt);
          return j;
        }
  ...
  public final int getState(int paramInt)
  {
    if (this.mService != null) {
      try
      {
        int i = this.mService.getState(1, paramInt);
        return i;
      }
      catch (RemoteException localRemoteException) {}
    }
    ...
    extends IControllerListener.Stub
  {
    ...
    {
      Controller.KeyRunnable localKeyRunnable;
      if ((paramKeyEvent.getControllerId() == 1) && (Controller.this.mListener != null))
      {
        localKeyRunnable = new Controller.KeyRunnable(Controller.this, paramKeyEvent);
        if (Controller.this.mHandler != null) {
          Controller.this.mHandler.post(localKeyRunnable);
        }
      }
      else
      {
      ...
      localKeyRunnable.run();
    }
    
    public void onMotionEvent(MotionEvent paramMotionEvent)
      throws RemoteException
    {
      Controller.MotionRunnable localMotionRunnable;
      if ((paramMotionEvent.getControllerId() == 1) && (Controller.this.mListener != null))
      {
        localMotionRunnable = new Controller.MotionRunnable(Controller.this, paramMotionEvent);
        if (Controller.this.mHandler != null) {
          Controller.this.mHandler.post(localMotionRunnable);
        }
      }
      else
      {
      ...
      localMotionRunnable.run();
    }
    
    public void onStateEvent(StateEvent paramStateEvent)
      throws RemoteException
    {
      Controller.StateRunnable localStateRunnable;
      if ((paramStateEvent.getControllerId() == 1) && (Controller.this.mListener != null))
      {
        localStateRunnable = new Controller.StateRunnable(Controller.this, paramStateEvent);
        if (Controller.this.mHandler != null) {
          Controller.this.mHandler.post(localStateRunnable);
        }
      }
      else
      {
 ...
 * Qualified Name:     com.bda.controller.Controller
