  ...
  implements MediaController.MediaPlayerControl
{
  ...
  private MediaPlayer.OnErrorListener mErrorListener = new MediaPlayer.OnErrorListener()
  {
    public boolean onError(MediaPlayer paramAnonymousMediaPlayer, int paramAnonymousInt1, int paramAnonymousInt2)
    {
      ...
      {
        new AlertDialog.Builder(ADCCustomVideoView.this.activity()).setTitle("ERROR").setMessage(str).setPositiveButton("OKAY", new DialogInterface.OnClickListener()
        {
  ...
  SurfaceHolder.Callback mSHCallback = new SurfaceHolder.Callback()
  {
    public void surfaceChanged(SurfaceHolder paramAnonymousSurfaceHolder, int paramAnonymousInt1, int paramAnonymousInt2, int paramAnonymousInt3)
    {
      ...
      for (int j = 1;; j = 0)
      {
        if ((ADCCustomVideoView.this.mMediaPlayer != null) && (i != 0) && (j != 0))
        {
  ...
  ADCCustomVideoView(Context paramContext, boolean paramBoolean)
  {
    super(paramContext);
 ...
 * Qualified Name:     com.jirbo.adcolony.ADCCustomVideoView
