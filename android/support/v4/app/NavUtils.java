...
public class NavUtils
{
    ...
    throws PackageManager.NameNotFoundException
  {
    ...
    return new Intent().setClassName(paramComponentName.getPackageName(), str);
  }
    ...
    throws PackageManager.NameNotFoundException
  {
    ...
    return new Intent().setClassName(paramContext, str);
  }
    ...
    implements NavUtils.NavUtilsImpl
  {
    public Intent getParentActivityIntent(Activity paramActivity)
    {
      ...
      return new Intent().setClassName(paramActivity, str);
    }
